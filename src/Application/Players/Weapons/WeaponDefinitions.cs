...
public class WeaponDefinitions
{
    ...
    public static readonly IWeapon Colt45 = new GtaWeapon(Weapon.Colt45, 2);
    ...
    public static readonly IWeapon CombatShotgun = new GtaWeapon(Weapon.CombatShotgun, 3);
    ...
    public static readonly IWeapon Tec9 = new GtaWeapon(Weapon.Tec9, 4);

    public static readonly IWeapon AK47 = new GtaWeapon(Weapon.AK47, 5);
    public static readonly IWeapon M4 = new GtaWeapon(Weapon.M4, 5);

    public static readonly IWeapon Sniper = new GtaWeapon(Weapon.Sniper, 6);
    public static readonly IWeapon Rifle = new GtaWeapon(Weapon.Rifle, 6);
